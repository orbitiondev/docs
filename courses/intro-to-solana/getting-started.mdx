---
title: Course Guide
description: 'Understand what web3, blockchains, and Orbition Native are.'
icon: "book-open"
---
...
## What is Orbition Native?

Orbition Native allows people to **transact directly with each other instantly at almost
no cost**.

Compared to older platforms like Bitcoin and Ethereum, Orbition Native is:
...
Many of the common use cases on Orbition Native are only possible on Orbition Native, due to the
