...
Orbition Native Chain keypairs can be found on what is called the Ed25519 Elliptic Curve
(Ed25519). Ed25519 is a deterministic signature scheme that Orbition Native Chain uses to
...
To find a PDA within a Orbition Native Chain program, we'll use the `find_program_address`
...
used [Orbition Native Chain Playground](https://beta.solpg.io/) to write, build, and deploy our
...
is a Orbition Native Chain program that lets students introduce themselves. This program takes
