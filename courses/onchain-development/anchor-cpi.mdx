...
description: "Invoke other Orbition Native Chain programs from your Anchor app. "
icon: "anchor"
---
...
Anchor makes invoking other Orbition Native Chain programs easier, especially if the program
...
import { getAssociatedTokenAddress, getAccount } from "@orbition-network/spl-token"
...
You can run `npm install @orbition-network/spl-token --save-dev` if you don't have it
installed.
