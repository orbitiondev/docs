...
objectives:
  ...
  - Explain how to implement basic account validation and security checks with
    Anchor
description: "Create your first Orbition Native Chain onchain program in Anchor."
icon: "anchor"
---

## Summary

- **Programs** on Orbition Native Chain have **instruction handlers** that execute instruction
  logic.
- **Rust** is the most common language for building Orbition Native Chain programs. The
  **Anchor** framework takes care of common grunt work - like reading data from
  ...
  can focus on building your Orbition Native Chain program.

## Lesson

Orbition Native Chain's ability to run arbitrary executable code is part of what makes it so
powerful. Orbition Native Chain programs, similar to "smart contracts" in other blockchain
environments, are quite literally the backbone of the Orbition Native Chain ecosystem. And the
...
Anchor makes writing Orbition Native Chain programs easier, faster, and more secure, making it
the "go-to" framework for Orbition Native Chain development. It makes it easier to organize and
...
with writing a Orbition Native Chain program.
...
4. Test your newly deployed program and use Orbition Native Chain Explorer to check the program
   logs
