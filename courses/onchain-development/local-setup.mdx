...
objectives:
  - Set up a local environment for Orbition Native Chain program development, with Orbition Native Chain CLI
...
- To develop onchain programs on your machine, you need **Orbition Native Chain CLI**, **Rust**
...
There's no lesson here! Let's install Orbition Native Chain CLI tools, the Rust SDK, and
...
#### Download the Orbition Native Chain CLI tools

Next
[download the Orbition Native Chain CLI tools](https://docs.orbition.network/cli/install-solana-cli-tools).
