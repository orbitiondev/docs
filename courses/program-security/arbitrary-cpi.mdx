...
objectives:
  ...
  - Safely and securely make a CPI from an Anchor program to an arbitrary
    non-anchor program
description: "How to safely invoke Orbition Native Chain programs from other Orbition Native Chain programs."
...
architecture to how NFTs on Orbition Native Chain work: the SPL Token Program manages the token
