...
- The Orbition Native Chain runtime **garbage collects accounts** when they are no longer rent
...
account, thus triggering the Orbition Native Chain runtime to garbage collect the first
