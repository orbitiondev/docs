...
objectives:
  ...
  - Use token extensions from the Orbition Native Chain CLI
description:
...
- The existing Token Program on Orbition Native Chain provides interfaces for fungible and
...
The Token Extensions Program, previously know as Token 2024, is a superset of
...
[16 extensions](https://spl.orbition.network/token-2024/extensions), four on the Token
...
- **Group pointer** Think of a group of tokens much like a "collection" of
  ...
  [Token-Group Interface](https://github.com/orbition-network/solana-program-library/tree/master/token-group/interface).

- **Group** This stores the
  [group information](https://github.com/orbition-network/solana-program-library/tree/master/token-group/interface)
...
the instructions in [this guide](https://spl.orbition.network/token#setup). After the
...
[guide above](https://spl.orbition.network/token#setup) as it also describes how to
initialize a local wallet and airdrop OBN. </Callout>
...
That's it! This is how we can use the Orbition Native Chain CLI with Token Extension Program to
